...
<body>
    ...
    <div class="container-fluid" id="header">
        ...
        <div class="container pt-5 d-flex justify-content-center" id="arrow">
            <div class="button">
                <div class="first">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                          <p class="footer-text">anetaklepkotleta@obiad.com</p>
                        </li>
                        <li>
