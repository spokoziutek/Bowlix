    ...
    <nav class="navbar navbar-expand-md fixed-top">
        <div class="container-fluid" id="navbar-container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="onas.php">Rejestracja</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5" id="cards">
        ...
        <div class="row mt-5">
            <div class="col-sm-12 col-lg-6 col-text2">
                ...
                <p class="cards-text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora iure reiciendis ea saepe eveniet laudantium, libero ab cumque nihil? Exercitationem repellendus, maiores unde quam cupiditate dolor nihil quo nisi eaque!
                </p>
            </div>
